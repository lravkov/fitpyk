...
def objective(inputs_):
    ...
    for i_ in range(range_val_):
        ...
        a_ = 0.293  # lattice parameter in [nm]

        # b_ = a_ # burgers vector (not sure if this is 100% right)
        b_ = 3 ** (1 / 2) * a_ / 2  # sqrt(2)*a/2
        # print(b_)
...
if __name__ == "__main__":
    si_peaks = pd.read_csv('Ti5553_to_mwh_optimize.txt')
    ...
    for n in range(1, len(pattern_list)):
        ...
        with open('Ti5553_mwh_output_2.txt', 'a') as f:
