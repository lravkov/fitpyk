...
if __name__ == "__main__":
    ...
    storage_dir = 'D:/PyCharmProjects/fityk_scripting_2022/ANSTO_DATA/GE-4-ss316block3b/results/'
    file_name = 'mWH-worthy-GE4-allpeaks.txt'
    ...
    list_of_filter_info = ["'-110--120'", "'-120--110'", "'-130--120'", "'-140--130'",
    ...
    for pos, fwhms in enumerate(list_of_fwhms_to_fit):
        if len(fwhms) >= number_of_peaks:
            ...
            if (len(fwhms) - counter) >= number_of_peaks:
                ...
                # CREATE THE DATASET TO OPTIMIZE - REMEMBER TO UNCOMMENT OUT OTHER SECTION TOO
                # with open('GE4_to_mwh_optimize.txt', 'a') as f:
