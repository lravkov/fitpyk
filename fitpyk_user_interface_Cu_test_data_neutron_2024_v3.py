...
if __name__ == "__main__":
    ...
    data_dir = 'test-data/transverse'  # no / at end of data dir name
    storage_dir_name = '_results/'
    file_prefix = 'K'
    file_spacer = '_'
    file_suffix = '.gda-bank1'
    ...
    file_storage_loc = 'test-data/transverse_results/47938-47968/'
