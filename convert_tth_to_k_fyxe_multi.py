...
if __name__ == "__main__":
    base_path = 'D:/PyCharmProjects/fityk_scripting_2022/APS-SS316L-triangles-2022/lr_dt_hd_1_4permm2/ge1-gsas-output-caked/'
    E_keV = 65.35
    start_sample_number = 1558
    number_of_samples = 1512

    for i in range(number_of_samples):
        data_filename = f'lr_dt_hd_1_4permm2_{str(start_sample_number + i).zfill(6)}.fxye'
        output_filename = f'K_lr_dt_hd_1_4permm2_{str(start_sample_number + i).zfill(6)}.dat'
