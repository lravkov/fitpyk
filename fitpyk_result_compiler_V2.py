...
def fitpyk_get_output_data(base_path_p, output_file_p, info_p):
    if os.path.exists(base_path_p):
        ...
        with open(base_path_p + '/' + output_file_p, 'w') as filetowrite:
            filetowrite.write('pattern_number, centre, delta_centre, left_hwhm, left_delta_hwhm, right_hwhm, right_delta_hwhm, height, delta_height, info\n')
                ...
                for line in f:
                    ...
                    if line.startswith('%'):
                        ...
                        if type_list[0] != 'Polynomial6':
                            ...
                            output_data = [pattern_number, centre, delta_centre, left_hwhm, delta_left_hwhm, right_hwhm, delta_right_hwhm, height, delta_height, info_p]
...
if __name__ == "__main__":
    base_path = 'D:/PyCharmProjects/fityk_scripting_2022/ANSTO_DATA/GE-1-ss316block3b/results/180--170_180170_mar_20'
    output_file = 'combined_results_hwhm_info.txt'
    info = '-180--170'
