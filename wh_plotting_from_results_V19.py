...
if __name__ == "__main__":
    ...
    rel_error = 0.02
    pos = 0
    pattern_number_list_180170 = []
    fwhm_list_180170 = []
    delta_fwhm_list_180170 = []
    centre_list_180170 = []
    for value in delta_fwhm_list:

        if info_list[pos] == "'-180--170'":
            pattern_number_list_180170.append(pattern_number_list[pos])
            fwhm_list_180170.append(fwhm_list[pos])
            delta_fwhm_list_180170.append(delta_fwhm_list[pos])
            centre_list_180170.append(centre_list[pos])
