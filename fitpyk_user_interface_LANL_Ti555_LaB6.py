...
if __name__ == "__main__":
    ...
    data_dir = 'LANL-Ti-5553'  # no / at end of data dir name
    storage_dir_name = '_instrumentals/'
    file_prefix = 'TI5553_GE2_CALIB_RUN_35_FOR_RUN_35'
    file_spacer = '_'
    file_suffix = ''
    data_type = 'txt'  # do not include '.' before the file type
    z_fill = 5  # number of integers in pattern name (e.g 00XXX) would be 5
    first_file = 35  # 155
    number_of_spectra = 2  # 179
    max_iterations = 3  # 3 is enough to stabilize
    results_filename = 'K_results.txt'  # do not change this name
    info = add_LANL_Ti555_LaB6_poly_info
    peaks = add_LANL_Ti555_LaB6_poly_peaks
