...
if __name__ == "__main__":
    df = pd.read_csv('ANSTO_DATA/GE4_mwh_output.txt')
    patterns = df.iloc[:, 0]
    infos = df.iloc[:, 1]
    results = df.iloc[:, 2]
    ...
    print('----------')
    f_pnl_155184, a_rhoal_155184, missing_155184 = get_row_b3(patternas, rhoas, 155.0, 184.0)
    ...
    print('----------')
    f_pnl_185214, a_rhoal_185214, missing_185214 = get_row_b3(patternas, rhoas, 185.0, 214.0)
    ...
    print('----------')
    f_pnl_215244, a_rhoal_215244, missing_215244 = get_row_b3(patternas, rhoas, 215.0, 244.0)
    ...
    print('----------')
    f_pnl_245274, a_rhoal_245274, missing_245274 = get_row_b3(patternas, rhoas, 245.0, 274.0)
    ...
    print('----------')
    f_pnl_275304, a_rhoal_275304, missing_275304 = get_row_b3(patternas, rhoas, 275.0, 304.0)
    ...
    print('----------')
    f_pnl_305334, a_rhoal_305334, missing_305334 = get_row_b3(patternas, rhoas, 305.0, 334.0)
    ...
    print('----------')
    f_pnl_335364, a_rhoal_335364, missing_335364 = get_row_b3(patternas, rhoas, 335.0, 364.0)
    ...
    print('----------')
    f_pnl_365394, a_rhoal_365394, missing_365394 = get_row_b3(patternas, rhoas, 365.0, 394.0)
    ...
    print('----------')
    f_pnl_395424, a_rhoal_395424, missing_395424 = get_row_b3(patternas, rhoas, 395.0, 424.0)
    ...
    print('----------')
    f_pnl_425454, a_rhoal_425454, missing_425454 = get_row_b3(patternas, rhoas, 425.0, 454.0)
    ...
    print('----------')
    f_pnl_455484, a_rhoal_455484, missing_455484 = get_row_b3(patternas, rhoas, 455.0, 484.0)
    ...
    print('----------')
    f_pnl_485514, a_rhoal_485514, missing_485514 = get_row_b3(patternas, rhoas, 485.0, 514.0)
    ...
    print('----------')
    f_pnl_515544, a_rhoal_515544, missing_515544 = get_row_b3(patternas, rhoas, 515.0, 544.0)
    ...
    print('----------')
    f_pnl_545574, a_rhoal_545574, missing_545574 = get_row_b3(patternas, rhoas, 545.0, 574.0)
    ...
    # write to file
    # with open(r'D:/PyCharmProjects/fityk_scripting_2022/ANSTO_DATA/GE4_mwhoutput.txt', 'w') as f:
    #     for item in z:
    ...
    ax.set_title('rho vs. Location - GE4')
