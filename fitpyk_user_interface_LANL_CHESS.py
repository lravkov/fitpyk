...
if __name__ == "__main__":
    ...
    data_dir = 'LANL-CHESS-may-2022/CeO2/90'  # no / at end of data dir name
    storage_dir_name = '_instrumentals_test/'
    file_prefix = 'ff'
    file_spacer = '_'
    file_suffix = ''
