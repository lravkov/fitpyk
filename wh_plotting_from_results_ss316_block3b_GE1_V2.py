...
def filter_results(info_p, rel_error_p, pattern_number_list_p, centre_list_p, delta_centre_list_p, fwhm_list_p, delta_fwhm_list_p, left_hwhm_list_p, delta_left_hwhm_list_p, right_hwhm_list_p, delta_right_hwhm_list_p, height_list_p, delta_height_list_p, lshape_list_p, delta_lshape_list_p, rshape_list_p, delta_rshape_list_p, info_list_p):
    ...
    for value_p in delta_fwhm_list_p:
        ...
        if value_p >= rel_error_p * fwhm_list_p[pos] or fwhm_list_p[pos] >= 0.026 or fwhm_list_p[pos] <= 0.001 or centre_list_p[pos] <= 10.25 or centre_list_p[pos] >= 11:  # was [8, 9] FOR 2D PLOTS, [5, 5.5], [5.5, 6.5], [8, 9], [9.5, 10.25], [10.25, 11] (problems with this one), [11.5, 12.5] (problems with this one)
            pattern_number_list_p[pos] = np.NaN
            fwhm_list_p[pos] = np.NaN
            delta_fwhm_list_p[pos] = np.NaN
            left_hwhm_list_p[pos] = np.NaN
...
if __name__ == "__main__":
    ...
    data_filename = 'combined_results_all_params_all_patterns_GE1.txt'
    rel_error = 0.02
    ...
    f_pnl_155184, a_fwhml_155184, missing_155184 = get_row_b(f_pnl, a_fwhml, 155.0, 184.0)
    print('----------')
    ...
    f_pnl_185214, a_fwhml_185214, missing_185214 = get_row_b(f_pnl, a_fwhml, 185.0, 214.0)
    print(missing_185214)

    f_pnl_215244, a_fwhml_215244, missing_215244 = get_row_b(f_pnl, a_fwhml, 215.0, 244.0)
    print(missing_215244)

    f_pnl_245274, a_fwhml_245274, missing_245274 = get_row_b(f_pnl, a_fwhml, 245.0, 274.0)
    print(missing_245274)

    f_pnl_275304, a_fwhml_275304, missing_275304 = get_row_b(f_pnl, a_fwhml, 275.0, 304.0)
    print(missing_275304)

    f_pnl_305334, a_fwhml_305334, missing_305334 = get_row_b(f_pnl, a_fwhml, 305.0, 334.0)
    print(missing_305334)

    f_pnl_335364, a_fwhml_335364, missing_335364 = get_row_b(f_pnl, a_fwhml, 335.0, 364.0)
    print(missing_335364)

    f_pnl_365394, a_fwhml_365394, missing_365394 = get_row_b(f_pnl, a_fwhml, 365.0, 394.0)
    print(missing_365394)

    f_pnl_395424, a_fwhml_395424, missing_395424 = get_row_b(f_pnl, a_fwhml, 395.0, 424.0)
    print(missing_395424)

    f_pnl_425454, a_fwhml_425454, missing_425454 = get_row_b(f_pnl, a_fwhml, 425.0, 454.0)
    print(missing_425454)

    f_pnl_455484, a_fwhml_455484, missing_455484 = get_row_b(f_pnl, a_fwhml, 455.0, 484.0)
    print(missing_455484)

    f_pnl_485514, a_fwhml_485514, missing_485514 = get_row_b(f_pnl, a_fwhml, 485.0, 514.0)
    print(missing_485514)

    f_pnl_515544, a_fwhml_515544, missing_515544 = get_row_b(f_pnl, a_fwhml, 515.0, 544.0)
    print(missing_515544)

    f_pnl_545574, a_fwhml_545574, missing_545574 = get_row_b(f_pnl, a_fwhml, 545.0, 574.0)
    print(missing_545574)

    f_pnl_575604, a_fwhml_575604, missing_575604 = get_row_b(f_pnl, a_fwhml, 575.0, 604.0)
    print(missing_575604)

    f_pnl_605634, a_fwhml_605634, missing_605634 = get_row_b(f_pnl, a_fwhml, 605.0, 634.0)
    print(missing_605634)

    f_pnl_635664, a_fwhml_635664, missing_635664 = get_row_b(f_pnl, a_fwhml, 635.0, 664.0)
    ...
    # -------------- left hwhm (final 30)
    a_left_hwhml_635664 = a_left_hwhml[460:490]
    ...
    # -------------- right hwhm (final 30)
    a_right_hwhml_635664 = a_right_hwhml[460:490]
    ...
    # -------------- left shape (final 30)
    a_left_shapel_635664 = a_left_shapel[460:490]
    ...
    a_right_shapel_635664 = a_right_shapel[460:490]
