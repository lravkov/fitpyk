...
if __name__ == "__main__":
    ...
    data_dir = 'LANL-Ti-5553-redo-2'  # no / at end of data dir name
    storage_dir_name = '_results/'
    file_prefix = 'BROWN_TI5553_SAXS_WAXS'
    file_spacer = '_'
    file_suffix = '_G2IMG_00001_0'
    ...
    info = add_LANL_Ti555_poly_info
    peaks = add_LANL_Ti555_poly_peaks
