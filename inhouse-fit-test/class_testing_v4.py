...
class Splitpearson7:
    ...
    def __call__(self, x, center_name, height_name, left_hwhm_name, left_shape_name, right_hwhm_name, right_shape_name):
        return splitpearson7(x, height_name, center_name, left_hwhm_name, left_shape_name, right_hwhm_name, right_shape_name)
...
if __name__ == '__main__':
    ...
    params = mod.make_params(cen1=12.11, h1=300, lh1=0.01, ls1=1, rh1=0.01, rs1=1,
                             c0=100, c1=0)
