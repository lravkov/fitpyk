...
if __name__ == "__main__":
    ...
    input_file_name = 'GE1_APS316_new.txt'
    output_file_name = 'GE1_APS316_new_mwh_output.txt'
    # ===========================================================================================================

    input_file = storage_dir + input_file_name
    output_file = storage_dir + output_file_name

    si_peaks = pd.read_csv(input_file)
    ...
    with open(output_file, 'a') as f:
        f.write(f'pattern, info, results\n')
