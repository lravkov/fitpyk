...
def process_data_threaded():
    ...
    while not q.empty():
        ...
        for file_number in chunk:
            ...
            spline_file = storage_dir + 'spline/' + file_prefix + file_spacer + str(file_number).zfill(
            ...
            fit_results_file = storage_dir + 'fit_results/' + file_prefix + file_spacer + str(file_number).zfill(
...
if __name__ == '__main__':
    ...
    # Split the files into chunks for each CPU core to process
    files = [file_number for file_number in range(first_file, first_file + number_of_spectra)]
