...
if __name__=='__main__':
    ...
    params = mod.make_params(center=13.61, amplitude=100,
                             sigma_left=0.01, m_left=1,
                             sigma_right=0.01, m_right=4,
                             c0=100, c1=0)
    result = mod.fit(y, params, x=x)
    ...
    # print(fit_results_array[6])
    # print(fit_results_array[7])
    # print(fit_results_array[8])
    ...
    # print(result.nvarys)
    y_fit = [splitpearson7(x=x, center=center.value, amplitude=amplitude.value, sigma_left=sigma_left.value, sigma_right=sigma_right.value, m_left=m_left.value, m_right=m_right.value) + c0.value + (c1.value * x) for x in xpos]
