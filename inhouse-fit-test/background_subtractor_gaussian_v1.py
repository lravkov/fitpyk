...
if __name__ == "__main__":
    ...
    storage_dir = 'D:/PyCharmProjects/fityk_scripting_2022/inhouse-fit-test/test_project/results_prec_test/'
    file_name = 'instrumental_results_all_params.txt'
    ...
    with open('GE1_APS316_prec_test.txt', 'w+') as file:
