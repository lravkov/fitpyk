...
def get_row_b3(pnl, fwhml, startnum, endnum):
    ...
    print(logged_missing_positions)
...
if __name__ == "__main__":
    ...
    input_file_name = 'GE1_APS316_new_mwh_output.txt'
    # ===========================================================================================================

    df = pd.read_csv(storage_dir + input_file_name)
    patterns = df.iloc[:, 0]
    infos = df.iloc[:, 1]
    results = df.iloc[:, 2]
    ...
    for row in range(numrows):
        ...
        print(newpattern)
        print(endpattern)
        f_pnl_p, a_fwhml_p, missing_p = get_row_b3(patternas, qas, newpattern, endpattern)  # rhoas, gsas, qas
    ...
    # ax.set_title('Hypotenuse Up 1 - Dislocation Density [m^-2] vs. Location [mm] - GE1')
    # ax.set_title('Hypotenuse Up 1 - Coherent Scattering Domain Size [nm] vs. Location [mm] - GE1')
    ax.set_title('Hypotenuse Up 1 - Edge/Screw Character vs. Location [mm] - GE1')
