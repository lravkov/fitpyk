...
if __name__ == '__main__':
    ...
    for t in range(NUM_THREADS):
        worker = Thread(target=process_data_threaded, args=(base_path, project_path, data_dir, storage_dir_name, file_prefix, file_spacer, file_suffix, data_type, z_fill, q, min_x, max_x, peak_centers, peak_heights, peak_types, bckgrd_pts, half_window, divs, use_poly6, max_nfev,)).start()
