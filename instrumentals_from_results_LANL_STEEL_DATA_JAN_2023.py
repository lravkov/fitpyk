...
if __name__ == "__main__":
    base_path = 'D:/PyCharmProjects/fityk_scripting_2022/LANL_STEEL_DATA_JAN_2023/hr-instrumental_results/135450-135451/'
    ...
    # CELH[9] = np.NaN
    # CELH[16] = np.NaN
    LHedited = LS                 # CHANGE THIS VALUE HERE, LH, RH, LS, RS
    # LHedited[9] = np.NaN
    # LHedited[16] = np.NaN
    ...
    # plt.ylim([0, 0.015])  # HWHM APS 2023
    # plt.ylim([0, 0.03])
    plt.ylim([0, 20])  # LS, RS
    plt.show()
    # interactive(True)
    ...
    # peakposH1 = [4.81026, 5.55736, 7.86034, 9.21505, 9.62523, 11.1165, 12.1134, 12.4282, 13.6106]  # these are the old ones
    peakposH1 = [4.837, 5.589, 7.900, 9.276, 9.684, 11.178, 12.189, 12.500, 13.693]
    #
