...
def unpack_all_results(base_path_p, data_filename_p):
    ...
    for i in range(len(data_temp_p)):
        ...
        if (data_name_p[0].split()[0][0] == 'D'):
            ...
            temp_magic_number = int(magic_string.split('.')[0][::-1].split('_')[0][::-1]) - 10000  # number matters: 5000, 10000, 20000
...
if __name__ == "__main__":
    # base_path = 'D:/PyCharmProjects/fityk_scripting_2022/LANL-CuFe-foils/SinSqPsi-LPA/100_100/'
    ...
    # bank_test = []
    #
    # bad_list = [10, 12]  # [5, 9] for 50_50, [10, 12] for 100_100, [2, 4] for 200_200
    ...
    peakposH1 = [5.223, 6.044, 8.560, 10.027, 10.464, 12.106]
    #
    ...
    lhwhmH1 = [0.0061913, 0.0068991, 0.0073061, 0.0080036, 0.0078056, 0.0095288]
    print(lhwhmH1)
    # [5.58986785e-06 1.72674026e-03 3.76614522e-03]
    rhwhmH1 = [0.0059589, 0.0071875, 0.0072516, 0.0080844, 0.0080401, 0.0099493]
    print(rhwhmH1)

    lshape = [3.6158980, 2.9488556, 3.1503169, 3.8424788, 4.1275932, 3.8779708]
    rshape = [2.2570824, 2.6621804, 3.1107972, 3.4507996, 3.7210359, 4.1235269]
