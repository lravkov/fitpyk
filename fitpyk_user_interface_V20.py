...
if __name__ == "__main__":
    ...
    data_directory = 'ANSTO_DATA/GE-1-ss316block3a/110--100'  # no / at end of data dir nam
    storage_directory_name = '_110100_feb/'
    data_type = 'dat'
    z_fill = 5
    filename_prefix = 'ss316block3a'
    filename_spacer = '_'
    filename_suffix = '.ge1.ave--110--100.chi.nohead'
    ...
    run_fitpyk_engine(base_path, data_directory, storage_directory_name, filename_prefix, filename_spacer,
                      ...
                      results_filename, add_ge1_block3a_ss316_110100_poly_info, add_ge1_block3a_ss316_110100_poly_peaks)
