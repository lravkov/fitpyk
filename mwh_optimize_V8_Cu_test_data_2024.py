...
def objective(inputs_):
    ...
    for i_ in range(range_val_):
        ...
        a_ = 0.361491  # lattice parameter in [nm] - 3.61491 angstroms for Cu at RT, https://journals.iucr.org/paper?S0567739469001549
...
if __name__ == "__main__":
    si_peaks = pd.read_csv('Cu_test_data_neutron_long_to_mwh_optimize.txt')
    ...
    for n in range(1, len(pattern_list)):
        ...
        with open('Cu_test_data_neutron_long_mwh_output.txt', 'a') as f:
