...
def unpack_all_results(base_path_p, data_filename_p):
    ...
    for i in range(len(data_temp_p)):
        ...
        if (data_name_p[0].split()[0][0] == 'D'):
            ...
            temp_magic_number = int(magic_string.split('.')[0][::-1].split('S')[0][::-1]) - 9  # number matters: 5000, 10000, 20000 > USE A NUMBER 1 SMALLER THAN YOUR STARTING, AND YOU NEED TO CHANGE THE .split('_') to the correct separator (usually _ or S).
...
if __name__ == "__main__":
    base_path = 'D:/PyCharmProjects/fityk_scripting_2022/APS-HX-april-2023/14-apr-2023/lab6_1/K-converted_results/10-11/'
    ...
    CELH[4] = np.NaN
    CELH[5] = np.NaN
    LHedited = RS                 # CHANGE THIS VALUE HERE, LH, RH, LS, RS ------ or FWHM
    LHedited[1] = np.NaN
    LHedited[4] = np.NaN
    LHedited[5] = np.NaN
    ...
    peakposH1 = [4.81026, 5.55736, 7.86034, 9.21505, 9.62523, 11.1165, 12.1134, 12.4282]
    #
